...
namespace Game.Scripts.TouchInput
{
    ...
    //      * Functions to change camera parameters

    public class CameraHandler
    {
        private static string PREFAB_PATH = "Data/Prefabs/GameCamera";

        private static readonly float PanSpeed = 250f;
        ...
        void PanCamera(Vector3 newPanPosition)
        {
            ...
            pos.x = Mathf.Clamp(camera.transform.position.x, BoundsX[0], BoundsX[1]);
            pos.z = Mathf.Clamp(camera.transform.position.z, BoundsZ[0], BoundsZ[1]);
